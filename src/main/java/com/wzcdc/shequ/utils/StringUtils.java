...
public final class StringUtils {
    ...
    public static boolean isEmpty(String str) {
        ...
        if ("".equals(str.trim()) || "null".equalsIgnoreCase(str.trim()))
            return true;
    ...
    public static String join(Object[] array, String delimiter, String surround) {
        ...
        for (Object item : array) {
            buffer.append(surround).append(item.toString()).append(surround)
                    .append(delimiter);
        }
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(getSubString(sql.toUpperCase(), "SELECT") + "---"
        // + sql.indexOf("SELECT"));
